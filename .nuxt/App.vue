...
export default {
  head: {"title":"ABC-Tutor","meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"hid":"description","name":"description","content":"Nuxt.js + Vuetify.js project"},{"name":"mobile-web-app-capable","content":"yes"},{"name":"apple-mobile-web-app-title","content":"ABC-Tutor"},{"name":"theme-color","content":"#F44336"},{"name":"og:type","content":"website"},{"name":"og:title","content":"ABC-Tutor"},{"name":"og:description","content":"ABC-Tutor System"}],"link":[{"rel":"icon","type":"image/x-icon","href":"/favicon.ico"},{"rel":"stylesheet","href":"https://fonts.googleapis.com/css?family=Roboto:300,400,500,700|Material+Icons"},{"rel":"manifest","href":"/_nuxt/manifest.7ed4980a.json"},{"rel":"shortcut icon","href":"/_nuxt/icons/icon_64.d4LbD0ZM723.png"},{"rel":"apple-touch-icon","href":"/_nuxt/icons/icon_512.d4LbD0ZM723.png","sizes":"512x512"}],"script":[{"src":"https://use.fontawesome.com/eed138f88e.js"}],"style":[],"htmlAttrs":{"lang":"en"}},
  data: () => ({
    layout: null,
    layoutName: ''
  }),
